...
export function CanvasText({
  ...
  useEffect(() => {
    ...
    const updateDimensions = () => {
      ...
      setDimensions({
        width: Math.ceil(rect.width) + 40 || 400, // 40px buffer: canvas ignores CSS letter-spacing so needs extra room
  ...
  return (
    ...
    >
      <span
        ...
        aria-hidden="true"
      />
      <span ref={textRef} className="invisible inline-block whitespace-pre" aria-hidden="true">
        {text}
      </span>
      <canvas
        ref={canvasRef}
